...
class ApfsDirectoryTest {
	...
	public void verifySize() {
		assertEquals(126, root.getTotalSize());
		assertEquals(120, home.getTotalSize());
		assertEquals(6, applications.getTotalSize());
		assertEquals(90, code.getTotalSize());
	}
	...
	public void verifyDirectoryEqualityHome() {
		String[] expected = { "root","true", "home", "0", localTime.toString(), "120", "3", "ApfsFile",localTime.toString() };
	...
	public void verifyDirectoryEqualityApplications() {
		String[] expected = { "root","true", "applications", "0", localTime.toString(), "6", "1", "ApfsFile",localTime.toString() };
	...
	public void verifyDirectoryEqualityCode() {
		String[] expected = { "home","true", "code", "0", localTime.toString(), "90", "3", "ApfsFile",localTime.toString() };
