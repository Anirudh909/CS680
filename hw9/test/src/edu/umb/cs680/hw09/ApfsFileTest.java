...
class ApfsFileTest {
	...
	public void verifyFileA() {
		String[] expected = { "false", "a", "applications", "6", localTime.toString(), "ApfsFile",localTime.toString() };
		ApfsFile actual = a;
	...
	public void verifyFileB() {
		String[] expected = { "false", "b", "home", "30", localTime.toString(), "ApfsFile",localTime.toString() };
		ApfsFile actual = b;
		assertArrayEquals(expected, filetoStringArray(actual));
		}
	...
	public void verifyFileC() {
		String[] expected = { "false", "c", "code", "40", localTime.toString(), "ApfsFile",localTime.toString() };
		ApfsFile actual = c;
		assertArrayEquals(expected, filetoStringArray(actual));
	}
	@Test
	public void verifyFileD() {
		String[] expected = { "false", "d", "code","50", localTime.toString(), "ApfsFile",localTime.toString() };
		ApfsFile actual = d;
		assertArrayEquals(expected, filetoStringArray(actual));
	}
